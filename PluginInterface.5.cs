...
namespace Invelos.DVDProfilerPlugin
{
	class PluginConstants
	{
		...
		public const int CURRENCY_HUF = 31;
		public const int CURRENCY_PLN = 32;
		public const int CURRENCY_CZK = 33;
		public const int CURRENCY_VND = 34;
		public const int CURRENCY_EEK = 35;
		public const int CURRENCY_RON = 36;
		public const int CURRENCY_SKK = 37;
	...
	public interface IDVDInfo
	{
		...
		void SetCastByIndex(int CastIndex, string FirstName, string MiddleName,
			...
			bool Voice, bool Uncredited, bool Puppeteer);
		...
		void AddCrew(string FirstName, string MiddleName,
			string LastName, int BirthYear, int CreditType, int CreditSubtype, string CreditedAs);
		void GetMediaTypes(out bool DVD, out bool HDDVD, out bool BluRay, out bool UltraHD);
		void SetMediaTypes(bool DVD, bool HDDVD, bool BluRay, bool UltraHD);
	...
	[Guid("5FB8BFA1-B3C0-4798-A52F-92763380D303"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
